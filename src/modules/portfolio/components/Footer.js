...
const Footer = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    "Olá, Kauã! Tudo bem? Vi o seu portfólio e gostaria de conversar sobre uma oportunidade.",
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-12 pt-8 border-t border-navy-blue-light/20 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-xs font-medium">
            © {currentYear} Kauã dos Santos Azeredo. Todos os direitos
            reservados.
          </p>
          <p className="text-slate-600 text-xs font-medium flex items-center gap-1">
            Feito com <span className="text-accent-blue">React</span> &{" "}
