        ...
        <div className="max-w-4xl text-center relative z-10">
          ...
          <ScrollReveal delay={300}>
            <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed font-light">
              Desenvolvedor Front-end especializado na criação de experiências digitais 
              responsivas, intuitivas e estritamente centradas no utilizador (UX).
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal delay={450}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
              ...
              >
                <UserRound size={18} className="text-slate-400 group-hover:text-accent-blue transition-colors duration-300" />
                Minha Trajetória
              </Link>
            </div>
          </ScrollReveal>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ScrollReveal>
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-white mb-4">Minha Especialidade</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <ScrollReveal delay={150}>
              <div className="group h-full p-8 rounded-3xl bg-soft-black/80 backdrop-blur-sm border border-navy-blue-light/30 hover:border-accent-blue/50 hover:bg-navy-blue/10 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-accent-blue/5">
                <div className="w-14 h-14 rounded-2xl bg-navy-blue-light/20 flex items-center justify-center mb-6 group-hover:bg-accent-blue/20 transition-colors duration-300">
                  <Layout className="text-accent-blue group-hover:scale-110 transition-transform duration-300" size={28} />
                </div>
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-accent-blue transition-colors duration-300">Front-end Expertise</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Domínio de React.js e Vue.js para a entrega de layouts escaláveis, arquitetura moderna e performance otimizada.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={300}>
              <div className="group h-full p-8 rounded-3xl bg-soft-black/80 backdrop-blur-sm border border-navy-blue-light/30 hover:border-accent-blue/50 hover:bg-navy-blue/10 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-accent-blue/5">
                <div className="w-14 h-14 rounded-2xl bg-navy-blue-light/20 flex items-center justify-center mb-6 group-hover:bg-accent-blue/20 transition-colors duration-300">
                  <Code2 className="text-accent-blue group-hover:scale-110 transition-transform duration-300" size={28} />
                </div>
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-accent-blue transition-colors duration-300">Design Responsivo</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Construção de interfaces estritamente centradas na experiência do utilizador (UX) utilizando o poder do Tailwind CSS.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={450}>
              <div className="group h-full p-8 rounded-3xl bg-soft-black/80 backdrop-blur-sm border border-navy-blue-light/30 hover:border-accent-blue/50 hover:bg-navy-blue/10 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-accent-blue/5">
                <div className="w-14 h-14 rounded-2xl bg-navy-blue-light/20 flex items-center justify-center mb-6 group-hover:bg-accent-blue/20 transition-colors duration-300">
                  <Database className="text-accent-blue group-hover:scale-110 transition-transform duration-300" size={28} />
                </div>
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-accent-blue transition-colors duration-300">Integração de APIs</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Experiência prática no consumo, tratamento de dados e integração de APIs RESTful para comunicação eficiente e segura.
                </p>
              </div>
            </ScrollReveal>
